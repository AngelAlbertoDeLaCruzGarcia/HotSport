...
<form action="../admi/buscar_sum.php" method="GET" class="form_buscar">
        ...
        <center> <font color = "white"><h1>Lista de Entrada de Productos</h1></font>
        </center>
              ...
              <div class="tam">
                    <table>
                      ...
                      <?php 
                        ...
                        $query=mysqli_query($conexion,"SELECT * FROM tblsuministrados_por                        
                        WHERE (dtFecha LIKE '%$dato%' OR
                        intIdproducto LIKE '%$dato%' OR
                        vchRFC LIKE '%$dato%' ) 
                        ...
                        if($row>0){
                            ...
                            while ($fila=mysqli_fetch_array($query)) {
                              $nuevo=$fila["intIdproducto"];
                              
                              /*if($nuevo>0){
                                 
                                $p=mysqli_query($conexion,"SELECT vchNombre FROM tblproductos WHERE intIdproducto=$nuevo");
                        ...
                        <tr>
                         ...
                         <td><?php echo $fila['intIdproducto'];?> </td>
