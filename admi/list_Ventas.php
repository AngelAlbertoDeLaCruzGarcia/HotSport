...
include '../php/head.php';?>
 ...
 <section class="nav">
    ...
    <form action="../admi/buscar_ventas.php" method="GET" class="form_buscar">
        ...
        <center> <font color = "white"><h1>Ventas</h1></font>
        </center>
        ...
        <center>
              <div class="tam">
                    <table>
                      ...
                      <?php 
                        include('../php/conexion.php');
                        $registro=mysqli_query($conexion,"SELECT COUNT(*) as registrot FROM vistaventa");
                        ...
                        $query=mysqli_query($conexion,"CALL splistventa($desde,$por_pagina);");
                      ...
                      <td><?php echo $fila['dtFecha'];?></td>
                         ...
                         <td><a href="../admi/mod_Ventas.php?Id=<?php echo $fila['intIdventa']?>">Editar</a></td>
                         <td><a href="#" onclick="preguntar(<?php echo $fila['intIdventa']?>)">Eliminar</a></td>
                       </tr>
                       <?php } } ?>
                    </table>
               </div>
