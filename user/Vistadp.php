...
<body>
            ...
            <div class="big-outer">
                ...
                <form method="POST" action="Carrito.php">
                    ...
                    <div id="detpro">
                        ...
                        <div class=detalle>
                            <div class="Nombre">
                                <p><?= $row['vchMarca'] . " " . $row['vchNombre'] ?></p>
                            </div>
                            <div class="Descripcion">
                                <p><?= $row['vchDescripcion'] ?> </p>
                            </div>
                            <div class="Precio">
                                <p><span class="icon-coin-dollar "></span><?= $row['fltPrecio'] ?></p>
                                <div>
    ...
    </section><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
