...
if(mysqli_num_rows($rows)==0)
    {
		...
		if(mysqli_num_rows($rows)==0)
    	{
			$insertar=mysqli_query($conexion,"INSERT INTO tblcliente
			(vchNombre,vchApaterno,vchAmaterno,vchCelular,vchEstado,vchCiudad,vchCalle,vchColonia,vchEmail)
			VALUES ('$nombre','$Apaterno','$Amaterno','$cel','$est','$ciu','$cal','$col','$email')");
